...
function EditItemForm({
  ...
  // retrive the item to edit and update corresponding states
  useEffect(() => {
    ...
    try {
      ...
      setItems((prevItems: ItemType[]) =>
        prevItems.map((item: ItemType) =>
          item._id === itemId
            ? { ...item, itemName, quantity, price, category }
            : item
        )
      );
  ...
  return (
    <div
      onClick={handleCloseEditItemForm}
